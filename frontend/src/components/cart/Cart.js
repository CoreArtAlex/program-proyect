                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div className="stockCounter d-inline">
                                                    ...
                                                    <span className="btn btn-outline-primary plus" onClick={() => increaseQty(item.product, item.quantity, item.stock)}>+</span>
                                                </div>
                                            </div>

                                            <div className="col-4 col-lg-1 mt-4 mt-lg-0 py-1">
                                                <i id="delete_cart_item" className="fa fa-trash btn btn-outline-danger" onClick={() => removeCartItemHandler(item.product)} ></i>
                                            </div>
